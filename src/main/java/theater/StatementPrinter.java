...
public class StatementPrinter {
    ...
    private static String usd(int dollars) {
        return NumberFormat.getCurrencyInstance(Locale.US).format(dollars / Constants.PERCENT_FACTOR);
    }
